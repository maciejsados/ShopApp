...
package maciej.example.com.storeapplication.fragment;
...
public class FruitsFragemnt_ViewBinding<T extends FruitsFragemnt> implements Unbinder {
  protected T target;

  @UiThread
  public FruitsFragemnt_ViewBinding(T target, View source) {
    this.target = target;
